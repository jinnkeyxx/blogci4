...
<html lang="en">
    <head>
        ...
        <!-- App css -->
        <link href="<?= base_url()  ?>/public/admin/assets\css\bootstrap.min.css" rel="stylesheet" type="text/css" id="bootstrap-stylesheet">
        <link href="<?= base_url()  ?>/public/admin/assets\css\icons.min.css" rel="stylesheet" type="text/css">
        <link href="<?= base_url()  ?>/public/admin/assets\css\app.min.css" rel="stylesheet" type="text/css" id="app-stylesheet">
